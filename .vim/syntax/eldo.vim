...
"ELDO COMMANDS
syntax match s_cmd "^\.AC\s\+"
syntax match s_cmd "^\.AGE\s\+"
syntax match s_cmd "^\.CHECKSOA\s*"
syntax match s_cmd "^\.DC\s\+"
syntax match s_cmd "^\.DCMISMATCH\s\+"
syntax match s_cmd "^\.DEX\s\+"
syntax match s_cmd "^\.DSP\s\+"
syntax match s_cmd "^\.DSPMOD\s\+"
syntax match s_cmd "^\.FOUR\s\+"
syntax match s_cmd "^\.LSTB\s\+"
syntax match s_cmd "^\.MC\s\+"
syntax match s_cmd "^\.NOISE\s\+"
syntax match s_cmd "^\.NOISETRAN\s\+"
syntax match s_cmd "^\.OP\s*"
syntax match s_cmd "^\.OPTFOUR\s\+"
syntax match s_cmd "^\.OPTIMIZE\s\+"
syntax match s_cmd "^\.OPTNOISE\s\+"
syntax match s_cmd "^\.PZ\s\+"
syntax match s_cmd "^\.RAMP\s\+"
syntax match s_cmd "^\.SENS\s\+"
syntax match s_cmd "^\.SENSAC\s\+"
syntax match s_cmd "^\.SENSPARAM\s\+"
syntax match s_cmd "^\.SNF\s\+"
syntax match s_cmd "^\.SOLVE\s\+"
syntax match s_cmd "^\.TF\s\+"
syntax match s_cmd "^\.TRAN\s\+"
syntax match s_cmd "^\.WCASE\s\+"
syntax match s_cmd "^\.EXTRACT\s\+"
syntax match s_cmd "^\.COMCHAR\s\+"
syntax match s_cmd "^\.DEFMAC\s\+"
syntax match s_cmd "^\.DEFPLOTDIG\s\+"
syntax match s_cmd "^\.DEFWAVE\s\+"
syntax match s_cmd "^\.EQUIV\s\+"
syntax match s_cmd "^\.EXTMOD\s\+"
syntax match s_cmd "^\.EXTRACT\s\+"
syntax match s_cmd "^\.FFILE\s\+"
syntax match s_cmd "^\.IPROBE\s\+"
syntax match s_cmd "^\.MEAS\s\+"
syntax match s_cmd "^\.MONITOR\s\+"
syntax match s_cmd "^\.NET\s\+"
syntax match s_cmd "^\.NEWPAGE\s\+"
syntax match s_cmd "^\.NOCOM\s\+"
syntax match s_cmd "^\.NOTRC\s\+"
syntax match s_cmd "^\.OP_DISPLAY\s\+"
syntax match s_cmd "^\.PLOT\s\+"
syntax match s_cmd "^\.PLOTBUS\s\+"
syntax match s_cmd "^\.PRINT\s\+"
syntax match s_cmd "^\.PRINTBUS\s\+"
syntax match s_cmd "^\.PRINTFILE\s\+"
syntax match s_cmd "^\.PROBE\s\+"
syntax match s_cmd "^\.PROBEBUS\s\+"
syntax match s_cmd "^\.WIDTH\s\+"
syntax match s_cmd "^\.CALL_TCL\s\+"
syntax match s_cmd "^\.CHECKBUS\s\+"
syntax match s_cmd "^\.CONSO\s*"
syntax match s_cmd "^\.CORREL\s\+"
syntax match s_cmd "^\.DATA\s\+"
syntax match s_cmd "^\.DISCARD\s\+"
syntax match s_cmd "^\.DISFLAT\s\+"
syntax match s_cmd "^\.DISTRIB\s\+"
syntax match s_cmd "^\.FFILE\s\+"
syntax match s_cmd "^\.FILTER\s\+"
syntax match s_cmd "^\.FORCE\s\+"
syntax match s_cmd "^\.FUNC\s\+"
syntax match s_cmd "^\.GUESS\s\+"
syntax match s_cmd "^\.IC\s*"
syntax match s_cmd "^\.INIT\s\+"
syntax match s_cmd "^\.LOAD\s\+"
syntax match s_cmd "^\.LOTGROUP\s\+"
syntax match s_cmd "^\.MCMOD\s\+"
syntax match s_cmd "^\.MODDUP\s\+"
syntax match s_cmd "^\.MPRUN\s\+"
syntax match s_cmd "^\.NODESET\s\+"
syntax match s_cmd "^\.NWBLOCK\s\+"
syntax match s_cmd "^\.OPTION\s*"
syntax match s_cmd "^\.OPTPWL\s\+"
syntax match s_cmd "^\.OPTWIND\s\+"
syntax match s_cmd "^\.PARAM\s\+"
syntax match s_cmd "^\.PARAMDEX\s\+"
syntax match s_cmd "^\.RESTART\s\+"
syntax match s_cmd "^\.SAVE\s\+"
syntax match s_cmd "^\.SETBUS\s\+"
syntax match s_cmd "^\.SETSOA\s\+"
syntax match s_cmd "^\.START_TIME\s\+"
syntax match s_cmd "^\.STEP\s\+"
syntax match s_cmd "^\.SUBDUP\s\+"
syntax match s_cmd "^\.TABLE\s\+"
syntax match s_cmd "^\.TEMP\s\+"
syntax match s_cmd "^\.TSAVE\s\+"
syntax match s_cmd "^\.USE\s\+"
syntax match s_cmd "^\.GUESS\s\+"
syntax match s_cmd "^\.USE_TCL\s\+"
syntax match s_cmd "^\.A2D\s\+"
syntax match s_cmd "^\.ADDLIB\s\+"
syntax match s_cmd "^\.ckt\s\+"
syntax match s_cmd "^\.AGE_LIB\s\+"
syntax match s_cmd "^\.AGEMODEL\s\+"
syntax match s_cmd "^\.ALTER\s\+"
syntax match s_cmd "^\.BIND\s\+"
syntax match s_cmd "^\.BINDSCOPE\s\+"
syntax match s_cmd "^\.CHRENT\s\+"
syntax match s_cmd "^\.CHRSIM\s\+"
syntax match s_cmd "^\.CONNECT\s\+"
syntax match s_cmd "^\.D2A\s\+"
syntax match s_cmd "^\.DEFAULT\s\+"
syntax match s_cmd "^\.DEFMOD\s\+"
syntax match s_cmd "^\.MODEL\s\+"
syntax match s_cmd "^\.DEL\s\+"
syntax match s_cmd "^\.DSPF_INCLUDE\s\+"
syntax match s_cmd "^\.END\s*"
syntax match s_cmd "^\.ENDL\s*"
syntax match s_cmd "^\.ENDS\s*"
syntax match s_cmd "^\.GLOBAL\s*"
syntax match s_cmd "^\.HIER\s\+"
syntax match s_cmd "^\.IGNORE_DSPF_ON_NODE\s\+"
syntax match s_cmd "^\.DSPF_INCLUDE\s\+"
syntax match s_cmd "^\.INCLUDE\s\+"
syntax match s_cmd "^\.LIB\s\+"
syntax match s_cmd "^\.LOOP\s\+"
syntax match s_cmd "^\.MALIAS\s\+"
syntax match s_cmd "^\.MODEL\s\+"
syntax match s_cmd "^\.MAP_DSPF_NODE_NAME\s\+"
syntax match s_cmd "^\.MODEL\s\+"
syntax match s_cmd "^\.MODLOGIC\s\+"
syntax match s_cmd "^\.MSELECT\s\+"
syntax match s_cmd "^\.PART\s\+"
syntax match s_cmd "^\.PROTECT\s\+"
syntax match s_cmd "^\.SCALE\s\+"
syntax match s_cmd "^\.SELECT_DSPF_ON_NODE\s\+"
syntax match s_cmd "^\.DSPF_INCLUDE\s\+"
syntax match s_cmd "^\.SETKEY\s\+"
syntax match s_cmd "^\.SIGBUS\s\+"
syntax match s_cmd "^\.SINUS\s\+"
syntax match s_cmd "^\.ENDS\s*"
syntax match s_cmd "^\.TITLE\s\+"
syntax match s_cmd "^\.TOPCELL\s\+"
syntax match s_cmd "^\.TVINCLUDE\s\+"
syntax match s_cmd "^\.UNPROTECT\s\+"
syntax match s_cmd "^\.USEKEY\s\+"
syntax match s_cmd "^\.VEC\s\+"

"ELDO RF COMMANDS
syntax match s_cmd "^\.SST\s\+"
syntax match s_cmd "^\.SST OSCIL\s\+"
syntax match s_cmd "^\.SST PLL\s\+"
syntax match s_cmd "^\.SST STABIL\s\+"
syntax match s_cmd "^\.SSTAC\s\+"
syntax match s_cmd "^\.SSTXF\s\+"
syntax match s_cmd "^\.SSTNLCONTRIB\s\+"
syntax match s_cmd "^\.SSTSENSRLC\s\+"
syntax match s_cmd "^\.SSTNOISE\s\+"
syntax match s_cmd "^\.SSTPROBE\s\+"
syntax match s_cmd "^\.SNF\s\+"
syntax match s_cmd "^\.WCASE\s\+"
syntax match s_cmd "^\.MC\s\+"
syntax match s_cmd "^\.MODSST\s\+"
syntax match s_cmd "^\.PART MODSST\s\+"
syntax match s_cmd "^\.RFBLOCK\s\+"
syntax match s_cmd "^\.CHRSIM\s\+"
syntax match s_cmd "^\.AGE\s\+"
syntax match s_cmd "^\.OP RF\s\+"

"Defined testbench commands - personnal
syntax match s_cmd "^\.Operating_Point\s*"
